...
async def help_message_f(client, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/Dads_links')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/Dads_links')
                ],
                [
                    InlineKeyboardButton('Developer', url='https://t.me/Dads_links'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('Source Code', url='https://github.com/Doctorstra') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
